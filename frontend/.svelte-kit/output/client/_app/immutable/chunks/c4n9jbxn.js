import { B as tick$1, Q as state, R as get$1, Z as set$1, r as onMount$1, rt as writable, t as index_client_exports, z as settled } from "./D_ZKicVc.js";
...
var base = globalThis.__sveltekit_1ks4p3p?.base ?? "";
var assets = globalThis.__sveltekit_1ks4p3p?.assets ?? base ?? "";
//#endregion
...
[.../* @__PURE__ */ new Set([...valid_layout_exports])];
//#endregion
...
var ICON_REL_ATTRIBUTES = /* @__PURE__ */ new Set([
	"icon",
	"shortcut icon",
	"apple-touch-icon"
]);
...
async function start(_app, _target, hydrate) {
	if (globalThis.__sveltekit_1ks4p3p.data) {
		const { q = {}, p = {}, l = {}, f = {} } = globalThis.__sveltekit_1ks4p3p.data;
...
async function _hydrate(target, { status = 200, error, node_ids, params, route, server_route, data: server_data_nodes, form }) {
	...
	try {
		...
		if (error instanceof Redirect) return await native_navigation(new URL(error.location, location.href));
