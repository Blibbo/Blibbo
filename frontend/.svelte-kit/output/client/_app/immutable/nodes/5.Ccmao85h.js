import { B as tick, C as if_block, D as append, G as child, H as template_effect, J as proxy, K as first_child, M as text, N as delegate, O as comment$1, P as delegated, Q as state, R as get, T as set_text, U as user_effect, V as untrack, Z as set, a as prop, b as snippet, ct as pop, d as attribute_effect, ft as next, g as attach, h as clsx, k as from_html, l as bind_this, lt as push, m as set_class, mt as noop, n as onDestroy, nt as remove_textarea_child, o as rest_props, pt as reset, q as sibling, r as onMount, s as spread_props, tt as user_derived, u as bind_value, y as component } from "../chunks/D_ZKicVc.js";
import "../chunks/DhaYE-8x.js";
import { a as Close_rounded, i as Meatballs_h, n as Hamburger_md, r as Meatballs_v, t as Cog } from "../chunks/BZBQPyqy.js";
import { t as MathField } from "../chunks/BwelQSYv.js";
...
var root_1$2 = from_html(`<div><div class="scm-waiting__loading scm-loading svelte-re3zpr"><div class="scm-loading__spinner svelte-re3zpr"></div> <p class="scm-loading__text svelte-re3zpr">Loading editor...</p></div> <pre class="scm-pre cm-editor svelte-re3zpr"> </pre></div>`);
function CodeMirror($$anchor, $$props) {
	push($$props, true);
	let value = prop($$props, "value", 15, ""), extensions = prop($$props, "extensions", 19, () => []), keybindings = prop($$props, "keybindings", 19, () => []), allowMultiSelect = prop($$props, "allowMultiSelect", 3, true), useTab = prop($$props, "useTab", 3, true), tabSize = prop($$props, "tabSize", 3, 2), lineWrapping = prop($$props, "lineWrapping", 3, false), lineNumbers$1 = prop($$props, "lineNumbers", 3, true), highlight = prop($$props, "highlight", 19, () => ({
		activeLine: true,
		activeLineGutter: true,
		specialChars: true,
		selectionMatches: true
	})), history$1 = prop($$props, "history", 3, true), foldGutter$1 = prop($$props, "foldGutter", 3, true), drawSelection$1 = prop($$props, "drawSelection", 3, true), dropCursor$1 = prop($$props, "dropCursor", 3, true), indentOnInput$1 = prop($$props, "indentOnInput", 3, true), syntaxHighlighting$1 = prop($$props, "syntaxHighlighting", 3, true), bracketMatching$1 = prop($$props, "bracketMatching", 3, true), closeBrackets$1 = prop($$props, "closeBrackets", 3, true), autocompletion$1 = prop($$props, "autocompletion", 3, true), rectangularSelection$1 = prop($$props, "rectangularSelection", 3, true), crosshairCursor$1 = prop($$props, "crosshairCursor", 3, true), editable = prop($$props, "editable", 3, true), readonly = prop($$props, "readonly", 3, false), nodebounce = prop($$props, "nodebounce", 3, false), classes = prop($$props, "class", 3, "");
	...
	let state_extensions = user_derived(() => [
		...get_base_extensions(),
		...get_theme(),
		...extensions()
	]);
	...
	let on_change = user_derived(() => nodebounce() ? handle_change : debounce(handle_change, 300));
	onMount(() => {
	...
	function create_editor_view() {
		return new EditorView({
			...
			dispatch(transaction) {
				...
				if (!get(update_from_prop) && transaction.docChanged) get(on_change)();
			}
		});
	}
	...
	function create_editor_state(value) {
		return EditorState.create({
			doc: value ?? void 0,
			extensions: get(state_extensions)
		});
	}
	...
	var consequent = ($$anchor) => {
		...
		template_effect(() => set_class(div, 1, clsx(["codemirror-wrapper", classes()]), "svelte-re3zpr"));
		append($$anchor, div);
	};
	var alternate = ($$anchor) => {
		...
		reset(div_1);
		template_effect(() => {
			set_class(div_1, 1, clsx(["scm-waiting", classes()]), "svelte-re3zpr");
			set_text(text, value());
		});
		append($$anchor, div_1);
	};
	if_block(node, ($$render) => {
		if (is_browser) $$render(consequent);
...
//#endregion
//#region node_modules/codemirror-lang-latex/dist/index.js
var VerbContent = 1;
var LstInlineContent = 2;
var LiteralArgContent = 3;
var SpaceDelimitedLiteralArgContent = 4;
var VerbatimContent = 5;
var Csname = 6;
var TrailingWhitespaceOnly = 7;
var TrailingContent = 8;
var hasMoreArguments = 376;
var endOfArguments = 377;
var hasMoreArgumentsOrOptionals = 378;
var endOfArgumentsAndOptionals = 379;
var Begin = 9;
var End = 10;
var RefCtrlSeq = 11;
var RefStarrableCtrlSeq = 12;
var CiteCtrlSeq = 13;
var CiteStarrableCtrlSeq = 14;
var LabelCtrlSeq = 15;
var MathTextCtrlSeq = 16;
var HboxCtrlSeq = 17;
var TitleCtrlSeq = 18;
var DocumentClassCtrlSeq = 19;
var UsePackageCtrlSeq = 20;
var HrefCtrlSeq = 21;
var UrlCtrlSeq = 22;
var VerbCtrlSeq = 23;
var LstInlineCtrlSeq = 24;
var IncludeGraphicsCtrlSeq = 25;
var CaptionCtrlSeq = 26;
var DefCtrlSeq = 27;
var LetCtrlSeq = 28;
var LeftCtrlSeq = 29;
var RightCtrlSeq = 30;
var NewCommandCtrlSeq = 31;
var RenewCommandCtrlSeq = 32;
var NewEnvironmentCtrlSeq = 33;
var RenewEnvironmentCtrlSeq = 34;
var BookCtrlSeq = 35;
var PartCtrlSeq = 36;
var ChapterCtrlSeq = 37;
var SectionCtrlSeq = 38;
var SubSectionCtrlSeq = 39;
var SubSubSectionCtrlSeq = 40;
var ParagraphCtrlSeq = 41;
var SubParagraphCtrlSeq = 42;
var InputCtrlSeq = 43;
var IncludeCtrlSeq = 44;
var ItemCtrlSeq = 45;
var NewTheoremCtrlSeq = 46;
var TheoremStyleCtrlSeq = 47;
var CenteringCtrlSeq = 48;
var BibliographyCtrlSeq = 49;
var BibliographyStyleCtrlSeq = 50;
var AuthorCtrlSeq = 51;
var AffilCtrlSeq = 52;
var AffiliationCtrlSeq = 53;
var DateCtrlSeq = 54;
var MaketitleCtrlSeq = 55;
var TextColorCtrlSeq = 56;
var ColorBoxCtrlSeq = 57;
var HLineCtrlSeq = 58;
var TopRuleCtrlSeq = 59;
var MidRuleCtrlSeq = 60;
var BottomRuleCtrlSeq = 61;
var MultiColumnCtrlSeq = 62;
var ParBoxCtrlSeq = 63;
var TextBoldCtrlSeq = 64;
var TextItalicCtrlSeq = 65;
var TextSmallCapsCtrlSeq = 66;
var TextTeletypeCtrlSeq = 67;
var TextMediumCtrlSeq = 68;
var TextSansSerifCtrlSeq = 69;
var TextSuperscriptCtrlSeq = 70;
var TextSubscriptCtrlSeq = 71;
var TextStrikeOutCtrlSeq = 72;
var EmphasisCtrlSeq = 73;
var UnderlineCtrlSeq = 74;
var SetLengthCtrlSeq = 75;
var DocumentEnvName = 76;
var TabularEnvName = 77;
var EquationEnvName = 78;
var EquationArrayEnvName = 79;
var VerbatimEnvName = 80;
var TikzPictureEnvName = 81;
var FigureEnvName = 82;
var ListEnvName = 83;
var TableEnvName = 84;
var OpenParenCtrlSym = 85;
var CloseParenCtrlSym = 86;
var OpenBracketCtrlSym = 87;
var CloseBracketCtrlSym = 88;
var LineBreakCtrlSym = 89;
var KnownEnvironment = 94;
var MAX_ARGUMENT_LOOKAHEAD = 100;
...
var elementContext = new ContextTracker({
	...
	shift(context, term, stack, input) {
		return term === Begin ? new ElementContext(envNameAfter(input, 6) || "", context) : context;
	},
	reduce(context, term) {
		return term === KnownEnvironment && context ? context.parent : context;
	},
	reuse(context, node, _stack, input) {
		return node.type.id === Begin ? new ElementContext(envNameAfter(input, 0) || "", context) : context;
	},
	hash(context) {
...
var verbTokenizer = new ExternalTokenizer((input, stack) => {
...
var lstinlineTokenizer = new ExternalTokenizer((input, stack) => {
	let delimiter = input.next;
	if (delimiter === -1) return;
	if (/\s/.test(String.fromCharCode(delimiter))) return;
	if (delimiter === CHAR_OPEN_BRACE) delimiter = CHAR_CLOSE_BRACE;
	input.advance();
	for (;;) {
		const next = input.next;
		if (next === -1 || next === CHAR_NEWLINE) return;
...
var matchForward = (input, expected, offset = 0) => {
	for (let i = 0; i < expected.length; i++) if (String.fromCharCode(input.peek(offset + i)) !== expected[i]) return false;
	return true;
};
var verbatimTokenizer = new ExternalTokenizer((input, stack) => {
	const delimiter = "\\end{" + stack.context.name + "}";
	for (let offset = 0;; offset++) if (input.peek(offset) === -1 || matchForward(input, delimiter, offset)) return input.acceptToken(VerbatimContent, offset);
}, { contextual: false });
var literalArgTokenizer = new ExternalTokenizer((input) => {
	for (let offset = 0;; offset++) {
		const next = input.peek(offset);
		if (next === -1 || next === CHAR_CLOSE_BRACE) return input.acceptToken(LiteralArgContent, offset);
	}
}, { contextual: false });
var spaceDelimitedLiteralArgTokenizer = new ExternalTokenizer((input) => {
	for (let offset = 0;; offset++) {
		const next = input.peek(offset);
		if (next === -1 || next === CHAR_SPACE || next === CHAR_NEWLINE) return input.acceptToken(SpaceDelimitedLiteralArgContent, offset);
	}
}, { contextual: false });
function _char(s) {
	return s.charCodeAt(0);
}
var CHAR_BACKSLASH = _char("\\");
var CHAR_OPEN_BRACE = _char("{");
var CHAR_OPEN_BRACKET = _char("[");
var CHAR_CLOSE_BRACE = _char("}");
var CHAR_TAB = _char("	");
var CHAR_SPACE = _char(" ");
var CHAR_NEWLINE = _char("\n");
var lookaheadTokenizer = (getToken) => new ExternalTokenizer((input) => {
	for (let i = 0; i < MAX_ARGUMENT_LOOKAHEAD; ++i) {
		const next = input.peek(i);
		if (next === CHAR_SPACE || next === CHAR_TAB) continue;
...
var argumentListTokenizer = lookaheadTokenizer((next) => {
	if (next === CHAR_OPEN_BRACE) return hasMoreArguments;
	else return endOfArguments;
});
var argumentListWithOptionalTokenizer = lookaheadTokenizer((next) => {
	if (next === CHAR_OPEN_BRACE || next === CHAR_OPEN_BRACKET) return hasMoreArgumentsOrOptionals;
	else return endOfArgumentsAndOptionals;
});
var CHAR_AT_SYMBOL = _char("@");
var csnameTokenizer = new ExternalTokenizer((input, stack) => {
	let offset = 0;
	let end = -1;
	const next = input.peek(offset);
	if (next === -1) return;
	if (next !== CHAR_BACKSLASH) return;
	offset++;
	for (;;) {
		const next = input.peek(offset);
...
var END_DOCUMENT_MARK = "\\end{document}".split("").reverse();
var trailingContentTokenizer = new ExternalTokenizer((input, stack) => {
	if (input.next === -1) return;
	for (let i = 1; i < END_DOCUMENT_MARK.length + 1; i++) if (String.fromCharCode(input.peek(-i)) !== END_DOCUMENT_MARK[i - 1]) return;
	while (input.next === CHAR_SPACE || input.next === CHAR_NEWLINE) if (input.advance() === -1) return input.acceptToken(TrailingWhitespaceOnly);
	while (input.advance() !== -1);
	return input.acceptToken(TrailingContent);
});
var refCommands = /* @__PURE__ */ new Set([
	"\\fullref",
	"\\Vref",
	"\\autopageref",
	"\\autoref",
...
var refStarrableCommands = /* @__PURE__ */ new Set([
	"\\vpageref",
	"\\vref",
	"\\zcpageref",
	"\\zcref",
...
var citeCommands = /* @__PURE__ */ new Set([
	"\\autocites",
	"\\Autocites",
	"\\Cite",
	"\\citeA",
...
var citeStarredCommands = /* @__PURE__ */ new Set([
	"\\cite",
	"\\citeauthor",
	"\\Citeauthor",
	"\\citedate",
...
var labelCommands = /* @__PURE__ */ new Set([
	"\\label",
	"\\thlabel",
	"\\zlabel"
]);
var mathTextCommands = /* @__PURE__ */ new Set([
	"\\text",
	"\\tag",
	"\\textrm",
	"\\intertext"
]);
var otherKnowncommands = {
	"\\hbox": HboxCtrlSeq,
	"\\title": TitleCtrlSeq,
...
var specializeCtrlSeq = (name, terms) => {
	if (name === "\\begin") return Begin;
	if (name === "\\end") return End;
	if (refCommands.has(name)) return RefCtrlSeq;
	if (refStarrableCommands.has(name)) return RefStarrableCtrlSeq;
	if (citeCommands.has(name)) return CiteCtrlSeq;
	if (citeStarredCommands.has(name)) return CiteStarrableCtrlSeq;
	if (labelCommands.has(name)) return LabelCtrlSeq;
	if (mathTextCommands.has(name)) return MathTextCtrlSeq;
	return otherKnowncommands[name] || -1;
};
var tabularEnvNames = /* @__PURE__ */ new Set([
	"tabular",
	"xltabular",
	"tabularx",
	"longtable"
]);
var equationEnvNames = /* @__PURE__ */ new Set([
	"equation",
	"equation*",
	"displaymath",
	"displaymath*",
...
var equationArrayEnvNames = /* @__PURE__ */ new Set([
	"array",
	"eqnarray",
	"eqnarray*",
	"align",
...
var verbatimEnvNames = /* @__PURE__ */ new Set([
	"verbatim",
	"boxedverbatim",
	"lstlisting",
	"minted",
...
var specializeEnvName = (name, terms) => {
	if (tabularEnvNames.has(name)) return TabularEnvName;
	if (equationEnvNames.has(name)) return EquationEnvName;
	if (equationArrayEnvNames.has(name)) return EquationArrayEnvName;
	if (verbatimEnvNames.has(name)) return VerbatimEnvName;
	return otherKnownEnvNames[name] || -1;
};
var otherKnownCtrlSyms = {
	"\\(": OpenParenCtrlSym,
	"\\)": CloseParenCtrlSym,
	"\\[": OpenBracketCtrlSym,
	"\\]": CloseBracketCtrlSym,
...
var specializeCtrlSym = (name, terms) => {
...
var parser = LRParser.deserialize({
	...
	tokenizers: [
		...
		lstinlineTokenizer,
		literalArgTokenizer,
		spaceDelimitedLiteralArgTokenizer,
		verbatimTokenizer,
		csnameTokenizer,
		trailingContentTokenizer,
		0,
		1,
		2,
		3,
		argumentListTokenizer,
		argumentListWithOptionalTokenizer
	],
	topRules: { "LaTeX": [0, 91] },
	specialized: [
		{
			term: 160,
			get: (value, stack) => specializeCtrlSeq(value) << 1,
			external: specializeCtrlSeq
		},
		{
			term: 114,
			get: (value, stack) => specializeEnvName(value) << 1,
			external: specializeEnvName
		},
		{
			term: 152,
			get: (value, stack) => specializeCtrlSym(value) << 1,
			external: specializeCtrlSym
		}
	],
	tokenPrec: 18067
});
...
function isInMathMode(context) {
	const dollars = context.state.sliceDoc(0, context.pos).match(/\$/g);
...
function createEnvironmentCompletion(envName, autoCloseEnabled) {
	return {
		...
		apply: (view, completion, from, to) => {
			...
			} else if (/\\end\{[^}]*$/.test(beforeCursor)) view.dispatch({
				changes: {
					from,
					to,
					insert: `${envName}}`
...
function createCommandCompletion(cmd, autoCloseEnabled) {
	if (cmd.startsWith("\\begin{")) {
		...
		if (envMatch) {
			...
			return {
				...
				type: "function",
				apply: (view, completion, from, to) => {
					const indentMatch = view.state.doc.lineAt(from).text.match(/^(\s*)/);
					const currentIndentation = indentMatch ? indentMatch[1] : "";
					const innerIndentation = currentIndentation + "  ";
...
function latexCompletionSource(autoCloseTagsEnabled) {
	return function(context) {
		...
		if (isInCommandName(context)) {
			...
			if (cmdMatch) {
				let options = commands.map((cmd) => createCommandCompletion(cmd, autoCloseTagsEnabled));
				if (isInMathMode(context)) options = [...options, ...mathCommands.map((cmd) => createCommandCompletion(cmd, autoCloseTagsEnabled))];
...
var autoCloseEffect = StateEffect.define();
var autoCloseField = StateField.define({
	create: () => ({
		active: false,
		lastEnv: null
	}),
	update(value, tr) {
		for (let e of tr.effects) if (e.is(autoCloseEffect)) return {
			active: true,
			lastEnv: e.value.envName
		};
		return value;
	}
});
function getCurrentLineIndentation(view, pos) {
	const match = view.state.doc.lineAt(pos).text.match(/^(\s*)/);
...
function isAfterBeginEnvironment(view) {
	...
	const lineText = state.doc.lineAt(main.from).text;
...
var handleEnterInEnvironment = (view) => {
...
var autoCloseTags = [
	...
	keymap.of([{
		key: "Enter",
		run: handleEnterInEnvironment
	}, {
		key: "}",
		run: handleCloseBrace
	}]),
	EditorState.transactionFilter.of((tr) => {
		...
		changes.iterChanges((fromA, toA, fromB, toB, inserted) => {
			...
			if (beginMatch && tr.isUserEvent("input.complete")) {
				...
				if (!new RegExp(`\\\\end\\{${envName}\\}`).test(docText)) {
					const indentMatch = state.doc.lineAt(fromA).text.match(/^(\s*)/);
					const currentIndentation = indentMatch ? indentMatch[1] : "";
					const innerIndentation = currentIndentation + "  ";
					newChanges.push({
						from: toB,
...
function latexLinter(options = {}) {
	...
	return (view) => {
		...
		if (opts.checkMissingDocumentEnv) {
			...
			if (!hasDocumentEnv && doc.length > 100) diagnostics.push({
				from: 0,
		...
		if (opts.checkUnmatchedEnvironments) {
			...
			tree.cursor().iterate((node) => {
				...
				if (node.name === "BeginEnv") {
					...
					if (envNameNode) {
						...
						if (!beginEnvs.has(envName)) beginEnvs.set(envName, []);
						(_a = beginEnvs.get(envName)) === null || _a === void 0 || _a.push(node.from);
					}
				} else if (node.name === "EndEnv") {
					const envNameNode = findEnvName(node);
					if (envNameNode) {
						const envName = doc.sliceString(envNameNode.from, envNameNode.to);
						if (!endEnvs.has(envName)) endEnvs.set(envName, []);
						(_b = endEnvs.get(envName)) === null || _b === void 0 || _b.push(node.from);
					}
				}
			});
			for (const [envName, begins] of beginEnvs.entries()) {
				const ends = endEnvs.get(envName) || [];
				if (begins.length > ends.length) for (let i = ends.length; i < begins.length; i++) diagnostics.push({
					from: begins[i],
			...
			for (const [envName, ends] of endEnvs.entries()) {
				...
				if (ends.length > begins.length) for (let i = begins.length; i < ends.length; i++) diagnostics.push({
					from: ends[i],
		...
		if (opts.checkMissingReferences) {
			...
			tree.cursor().iterate((node) => {
				...
				if (node.name === "LabelCtrlSeq") {
					...
					const refArg = (_a = node.node.nextSibling) === null || _a === void 0 ? void 0 : _a.nextSibling;
			...
			for (const [ref, pos] of refs.entries()) if (!labels.has(ref)) diagnostics.push({
				from: pos,
				to: pos + ref.length + 6,
				severity: "warning",
...
function findEnvName(node) {
	...
	for (let child = node.node.firstChild; child; child = child.nextSibling) if (child.name === "EnvNameGroup") {
		envNameGroup = child;
		break;
	}
	if (envNameGroup) {
		for (let child = envNameGroup.firstChild; child; child = child.nextSibling) if (child.name === "EnvName" || child.name === "DocumentEnvName" || child.name === "TabularEnvName" || child.name === "EquationEnvName" || child.name === "EquationArrayEnvName" || child.name === "VerbatimEnvName" || child.name === "TikzPictureEnvName" || child.name === "FigureEnvName" || child.name === "ListEnvName" || child.name === "TableEnvName") return child;
	}
	return null;
}
var commandInfoMap = {
...
*/
var latexHoverTooltip = hoverTooltip((view, pos, side) => {
	...
	if (node.name === "CtrlSeq" || node.name.endsWith("CtrlSeq") || node.name === "Begin" || node.name === "End") {
		const info = commandInfoMap[view.state.sliceDoc(node.from, node.to)];
		if (info) return makeTooltip(info, node.from, node.to);
	}
	if (node.name === "EnvName" || node.name.endsWith("EnvName")) {
		const info = environmentInfoMap[view.state.sliceDoc(node.from, node.to)];
		if (info) return makeTooltip(info, node.from, node.to);
	}
	...
	if (parent && parent.name === "EnvNameGroup") {
		...
		if (envNameNode) {
			const info = environmentInfoMap[view.state.sliceDoc(envNameNode.from, envNameNode.to)];
			if (info) return makeTooltip(info, envNameNode.from, envNameNode.to);
		}
	}
	return null;
});
function findEnvNameNode(node) {
	if (!node) return null;
	for (let child = node.firstChild; child; child = child.nextSibling) if (child.name === "EnvName" || child.name === "DocumentEnvName" || child.name === "TabularEnvName" || child.name === "EquationEnvName" || child.name === "EquationArrayEnvName" || child.name === "VerbatimEnvName" || child.name === "TikzPictureEnvName" || child.name === "FigureEnvName" || child.name === "ListEnvName" || child.name === "TableEnvName") return child;
	return null;
}
...
var latexBracketMatching = bracketMatching({ brackets: "()[]{}" });
function commentFoldRanges(state, lineStart, lineEnd) {
	const doc = state.doc;
	const startLine = doc.lineAt(lineStart);
	if (startLine.text.startsWith("% {")) for (let lineNo = startLine.number + 1; lineNo <= doc.lines; lineNo++) {
...
var latexLanguage = LRLanguage.define({
...
[...autoCloseTags];
function latex(config = {}) {
	var _a, _b, _c, _d, _e;
	const options = {
		...config,
		autoCloseTags: (_a = config.autoCloseTags) !== null && _a !== void 0 ? _a : true,
		enableLinting: (_b = config.enableLinting) !== null && _b !== void 0 ? _b : true,
		enableTooltips: (_c = config.enableTooltips) !== null && _c !== void 0 ? _c : true,
		enableAutocomplete: (_d = config.enableAutocomplete) !== null && _d !== void 0 ? _d : true,
		autoCloseBrackets: (_e = config.autoCloseBrackets) !== null && _e !== void 0 ? _e : true
	};
	const extensions = [];
	extensions.push(latexLanguage.data.of({ autocomplete: latexCompletionSource(options.autoCloseTags) }));
	...
	if (options.autoCloseBrackets) extensions.push(closeBrackets());
	if (options.autoCloseTags) extensions.push(...autoCloseTags);
	if (options.enableLinting) extensions.push(linter(latexLinter()));
	if (options.enableTooltips) extensions.push(latexHoverTooltip);
...
var root_1$1 = from_html(`<button class="cursor-pointer pointer-events-auto w-full h-full flex justify-end"><!></button> <div><!></div>`, 1);
var root_2$1 = from_html(`<div class="absolute right-0 mt-2"><!></div>`);
var root_3$1 = from_html(`<button title="" class="
        fixed inset-0 preset-blur bg-on-light/overlay z-40
      "></button> <div class="fixed inset-0 pointer-events-none flex justify-center items-center z-50"><div class="pointer-events-auto"><!></div></div>`, 1);
var root_4$1 = from_html(`<!> <div><!></div>`, 1);
function MenuOld($$anchor, $$props) {
	push($$props, true);
	let icon = prop($$props, "icon", 3, "kebab"), type = prop($$props, "type", 3, "popup"), rest = rest_props($$props, rest_excludes$1);
	let menuShown = state(false);
	const toggle = () => {
		set(menuShown, !get(menuShown));
	};
	const hide = () => {
		set(menuShown, false);
	};
	...
	const popupAttachment = () => (menu) => {
		const handleClickOutside = (e) => {
			const target = e.target;
			if (!menu.contains(target) && (!get(button) || !get(button).contains(target))) hide();
		};
	...
	var consequent = ($$anchor) => {
		...
		attribute_effect(button_1, () => ({
			...rest,
			class: `${$$props.class ?? ""} cursor-pointer pointer-events-auto w-full h-full flex justify-center items-center`,
			onclick: toggle
		}));
		...
		snippet(node_2, () => $$props.buttonContent ?? noop);
		reset(button_1);
		bind_this(button_1, ($$value) => set(button, $$value), () => get(button));
		append($$anchor, button_1);
	};
	if_block(node, ($$render) => {
		if (type() !== "replace" || type() === "replace" && !get(menuShown)) $$render(consequent);
	});
	...
	var consequent_4 = ($$anchor) => {
		...
		var consequent_3 = ($$anchor) => {
			...
			reset(div_4);
			reset(div_3);
			delegated("click", button_3, hide);
			append($$anchor, fragment_3);
		};
		if_block(node_4, ($$render) => {
			if (type() === "replace") $$render(consequent_1);
			else if (type() === "popup") $$render(consequent_2, 1);
			else if (type() === "overlay") $$render(consequent_3, 2);
		});
		append($$anchor, fragment_1);
	};
	if_block(node_3, ($$render) => {
		if (get(menuShown)) $$render(consequent_4);
	});
	reset(div);
	append($$anchor, fragment);
	pop();
...
var root$1 = from_html(`<textarea></textarea>`);
var root_1 = from_html(`<div class="mt-2 flex flex-col bg-accent rounded-sm *:cursor-pointer *:p-2 *:hover:bg-white/20"><button>Math</button> <button>Text</button> <button>Code</button></div>`);
var root_2 = from_html(`<div class="text-lg rounded-sm bg-accent text-on-accent p-2 text-nowrap"><!></div>`);
var root_3 = from_html(`<div class="flex items-center"><div><!></div></div>`);
var root_4 = from_html(`<div><!> <!></div>`);
function BlibboField($$anchor, $$props) {
	push($$props, true);
	let field = prop($$props, "field", 15), readOnly = prop($$props, "readOnly", 3, false), hideButtonsOnBlur = prop($$props, "hideButtonsOnBlur", 3, true), noButtons = prop($$props, "noButtons", 3, false), editorType = prop($$props, "editorType", 7, "math"), divProps = rest_props($$props, rest_excludes);
	let value = state(proxy(field().value));
	user_effect(() => {
		if (get(value) !== field().value) field({
			...field(),
			value: get(value)
		});
	});
	user_effect(() => {
		if (field().value !== get(value)) set(value, field().value ?? "", true);
	});
	let editorElement = state(void 0);
	function focus() {
		get(editorElement)?.focus();
	}
	user_effect(() => {
		editorType();
		let cancelled = false;
	...
	function handleParentPointerDown(e) {
		if (!e.composedPath().includes(get(editorElement))) e.preventDefault();
	}
	...
	function handleKeydown(e) {
		if ($$props.onshiftenter) {
			...
			if (e.code === "Enter" && shiftDown) $$props.onshiftenter?.();
		}
		if ($$props.onemptybackspace && e.code === "Backspace" && get(value) === "") $$props.onemptybackspace();
	}
	function handleKeyup(e) {
		if ($$props.onshiftenter && (e.code === "ShiftLeft" || e.code === "ShiftRight")) shiftDown = false;
	}
	const codeMirrorKeybindings = [];
	if ($$props.onshiftenter) codeMirrorKeybindings.push({
		key: "Shift-Enter",
		run: () => {
			$$props.onshiftenter();
			return true;
	...
	if ($$props.onemptybackspace) codeMirrorKeybindings.push({
		key: "Backspace",
		run: (view) => {
			const { state } = view;
  ...
  `,
	...
	var consequent = ($$anchor) => {
		...
		attribute_effect(textarea, () => ({
			...$$props.textEditorProperties,
			class: `${$$props.textEditorProperties?.class ?? "" ?? ""}
        ${!readOnly() ? "focus:outline-2 outline-accent" : "outline-0"} placeholder:text-accent rounded-xs
        flex-1 w-0 min-h-lh field-sizing-content  overflow-clip
      `,
		...
		bind_this(textarea, ($$value) => set(editorElement, $$value), () => get(editorElement));
		bind_value(textarea, () => get(value), ($$value) => set(value, $$value));
		append($$anchor, textarea);
	};
	var consequent_1 = ($$anchor) => {
		{
			let $0 = user_derived(() => $$props.codeEditorProperties?.class ?? "");
			let $1 = user_derived(latex);
			CodeMirror($$anchor, spread_props(() => $$props.codeEditorProperties, {
	...
	var consequent_2 = ($$anchor) => {
		{
			let $0 = user_derived(() => `${$$props.mathEditorProperties?.class ?? ""}
        flex-1
      `);
			bind_this(MathField($$anchor, spread_props(() => $$props.mathEditorProperties, {
				get class() {
					return get($0);
				},
				onkeydown: handleKeydown,
				onkeyup: handleKeyup,
				get hideButtonsOnBlur() {
					return hideButtonsOnBlur();
				},
				get noButtons() {
					return noButtons();
				},
			...
			})), ($$value) => set(editorElement, $$value, true), () => get(editorElement));
		}
	};
	if_block(node, ($$render) => {
		if (editorType() === "text") $$render(consequent);
		else if (editorType() === "code") $$render(consequent_1, 1);
		else if (editorType() === "math") $$render(consequent_2, 2);
	});
	...
	var consequent_3 = ($$anchor) => {
		...
		{
			let $0 = user_derived(() => hideButtonsOnBlur() ? -1 : void 0);
			MenuOld(node_2, {
				icon: "meatballs",
				type: "popup",
				...
				children: ($$anchor, $$slotProps) => {
					...
					{
						const buttonContent = ($$anchor) => {
							next();
							var text$1 = text("Editor type");
	...
	if_block(node_1, ($$render) => {
		if ((get(focused) || !hideButtonsOnBlur()) && !noButtons()) $$render(consequent_3);
	});
	reset(div);
	append($$anchor, div);
	return pop($$exports);
...
var root = from_html(`<div class="flex flex-col *:my-3
  w-full px-1 sm:px-3 md:px-0
  text-2xl sm:text-4xl
"><!></div>`);
function _page($$anchor, $$props) {
	push($$props, true);
	let field = state(proxy(newBlibboFieldState()));
	let component = state(void 0);
	var div = root();
	var node = child(div);
	bind_this(BlibboField(node, {
		class: "w-full",
		editorType: "math",
		onshiftenter: () => {
	...
	}), ($$value) => set(component, $$value, true), () => get(component));
	reset(div);
	append($$anchor, div);
	pop();
}
